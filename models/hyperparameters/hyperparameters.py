...
class _Hyperparameters(object):
  ...
  def __init__(self,
    ...
    """
    if not tf.gfile.Exists(default_hparams_file):
      raise ValueError(
  ...
  def get_parameters(self, log_params):
    ...
    self._params, self._params_source = load_from_file(
        self._params,
        self._params_source,
        self._default_hparams_file)
    self._params, self._params_source = load_from_file(
        self._params,
        self._params_source,
        self._specific_hparams_file)
...
def get_hyperparameters(default_hparams_file,
  ...
  Returns:
    Python dictionary with all the final hyperparameters.
  """
  parameter = _Hyperparameters(default_hparams_file,
                               specific_hparams_file,
                               input_flags,
                               hparams_overrides)
