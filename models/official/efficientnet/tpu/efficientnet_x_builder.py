...
def efficientnet_x_params(model_name):
  ...
  params_dict = {
      ...
      'efficientnet-x-tpu-b1': (1.09, 1.05, 229, 0.2, 2),
      'efficientnet-x-tpu-b2': (1.29, 1.13, 244, 0.3, 1),
      'efficientnet-x-tpu-b3': (1.62, 1.27, 263, 0.3, 1),
      'efficientnet-x-tpu-b4': (2.38, 1.54, 299, 0.4, 1),
      'efficientnet-x-tpu-b5': (2.76, 1.96, 332, 0.4, 1),
      'efficientnet-x-tpu-b6': (3.01, 2.75, 328, 0.5, 1),
      'efficientnet-x-tpu-b7': (3.44, 3.26, 350, 0.5, 1),
      'efficientnet-x-gpu-b0': (1.0, 1.0, 224, 0.2, 4),
      'efficientnet-x-gpu-b1': (1.09, 1.05, 229, 0.2, 2),
      'efficientnet-x-gpu-b2': (1.24, 1.13, 237, 0.3, 1),
      'efficientnet-x-gpu-b3': (1.63, 1.31, 255, 0.3, 1),
      'efficientnet-x-gpu-b4': (2.4, 1.63, 282, 0.4, 1),
      'efficientnet-x-gpu-b5': (3.29, 1.94, 306, 0.4, 1),
      'efficientnet-x-gpu-b6': (4.28, 2.25, 328, 0.5, 1),
      'efficientnet-x-gpu-b7': (5.46, 2.58, 350, 0.5, 1),
  }
