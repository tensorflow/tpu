...
# ==============================================================================
"""Data parser and processing for Attribute-Mask R-CNN."""

import tensorflow.compat.v1 as tf

from dataloader import anchor
from dataloader import mode_keys as ModeKeys
from projects.fashionpedia.dataloader import tf_example_decoder
from projects.fashionpedia.utils import dataloader_utils
...
class Parser(object):
  ...
  def _parse_eval_data(self, data):
      ...
      labels: a dictionary of tensors used for training. The following describes
        ...
        groundtruths:
          ...
          classes: groundtruth classes annotations. The tennsor is padded
            with -1 to the fixed dimension [self._max_num_instances].
          attributes: groundtruth attributes annotations. The tennsor is padded
            with -1 to the fixed dimension [self._max_num_instances,
            self._num_attributes].
    ...
    groundtruths = {
        ...
        'attributes':
            tf.reshape(data['groundtruth_attributes'],
                       [-1, self._num_attributes]),
        'areas':
  ...
  def _parse_predict_data(self, data):
    ...
    if self._mode == ModeKeys.PREDICT_WITH_GT:
      ...
      groundtruths = {
          ...
          'boxes': boxes,
          'classes': data['groundtruth_classes'],
          'attributes': tf.reshape(data['groundtruth_attributes'],
                                   [-1, self._num_attributes]),
