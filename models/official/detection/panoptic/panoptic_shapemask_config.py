...
# ==============================================================================
"""Config template to train the Panoptic extension of ShapeMask."""
...
PANOPTIC_SHAPEMASK_CFG = params_dict.ParamsDict(base_config.BASE_CFG)
PANOPTIC_SHAPEMASK_CFG.override(
    {
        'type': 'panoptic_shapemask',
        'train': {
            'total_steps': 45000,
            'learning_rate': {
        ...
        'architecture': {
            'parser': 'panoptic_shapemask_parser',
            'backbone': 'resnet',
            'multilevel_features': 'fpn',
            'use_bfloat16': True,
        },
        'panoptic_shapemask_parser': {
            'output_size': [640, 640],
            'match_threshold': 0.5,
        ...
        'segmentation_head': {
            'level': 3,
            'num_classes': 14,  # Include background class 0.
            'num_convs': 0,
            'use_batch_norm': True,
            'batch_norm': {
                'batch_norm_momentum': 0.997,
...
PANOPTIC_SHAPEMASK_RESTRICTIONS = [
    'architecture.use_bfloat16 == panoptic_shapemask_parser.use_bfloat16',
    ...
    'shapemask_head.mask_crop_size == panoptic_shapemask_parser.mask_crop_size',
    'shapemask_head.upsample_factor == panoptic_shapemask_parser.upsample_factor',
]
