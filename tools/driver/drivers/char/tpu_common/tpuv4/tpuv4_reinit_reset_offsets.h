 ...
 */
#ifndef _DRIVERS_CHAR_TPU_COMMON_TPUV4_ASIC_FW_REINIT_RESET_OFFSETS_H_
#define _DRIVERS_CHAR_TPU_COMMON_TPUV4_ASIC_FW_REINIT_RESET_OFFSETS_H_ 
#include "drivers/asic_sw/asic_fw_reinit_reset_offsets.h"
#include "drivers/gasket/gasket_types.h"
struct tpuv4_reinit_reset_offsets {
 uint64 chip_reset;
};
