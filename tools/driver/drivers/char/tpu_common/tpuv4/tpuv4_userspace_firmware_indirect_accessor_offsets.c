 ...
 */
#include "tpuv4_userspace_firmware_indirect_accessor_offsets.h"
static const struct asic_fw_indirect_register_offsets
 tpuv4_userspace_firmware_indirect_accessor_offsets_all_offsets[1] = {
  { 0x46d0018,
                                      0x46d0020,
                                     0x46d0028,
                                    0x46d0030,
...
tpuv4_userspace_firmware_indirect_accessor_offsets_get(int index)
{
 if (index < 0 || index >= 1)
  return NULL;
 return &tpuv4_userspace_firmware_indirect_accessor_offsets_all_offsets
  [index];
}
